...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-05-2021 a las 22:52:16
...
ALTER TABLE `tbl_facturas`
  ...
  ADD KEY `KF_DIRECCIONES_FACTURA` (`ID_DIRECCION`);
...
--
ALTER TABLE `tbl_envios`
  ADD CONSTRAINT `FK_DIRECCIONES_ENVIOS` FOREIGN KEY (`ID_DIRECCION`) REFERENCES `tbl_direccion` (`ID_DIRECCION`);

--
-- Filtros para la tabla `tbl_facturas`
--
ALTER TABLE `tbl_facturas`
  ADD CONSTRAINT `FK_DIRECCIONES_FACTURA` FOREIGN KEY (`ID_DIRECCION`) REFERENCES `tbl_direccion` (`ID_DIRECCION`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `tbl_inventario`
--
ALTER TABLE `tbl_inventario`
  ADD CONSTRAINT `FK_DIRECCIONES_INVENTARIO` FOREIGN KEY (`ID_DIRECCION`) REFERENCES `tbl_direccion` (`ID_DIRECCION`);
